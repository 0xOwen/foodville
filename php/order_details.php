...
$conn = connect();
$sql = "SELECT orders.orderDate, foods.name, orders.quantity, foods.price*orders.quantity AS bill, users.username 
			FROM orders 
...
?>
    ...
    <div id="content">
                <div class="Item">			   
				<h2 style="color:#f07341; padding-left: 190px;">Orders</h2>
